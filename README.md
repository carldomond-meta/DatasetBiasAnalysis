...
2. **Analyze** — Uses the Maverick 17B 128E via the Llama API to determine if behaviors within each taxonomy are exhibited through the same method or different methods
